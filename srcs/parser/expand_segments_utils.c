...
/*   Updated: 2025/12/05 16:10:06 by sdossa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Ajoute un mot au tableau en g̩rant le contexte actuel.
...
/*
** Traite les mots d'un segment non-quot̩ avec word spliting.
** Return 0 si succ̬s, -1 si erreur.
*/
/*
** Traite les mots d'un segment non-quot̩ avec word spliting.
...
/*
** Traite un seul segment (quot̩ ou non-quot̩).
** Return 0 si succ̬s, -1 si erreur.
*/
static int	process_segment(char *temp, int *i, t_segment_ctx *ctx)
{
...
/*
** Traite un token segment par segment (quot̩/non-quot̩).
** Applique le word splitting uniquement sur les segments non-quot̩s.
*/
int	process_token_by_segments(char **exp, int j, char *temp, int max)
{
	t_segment_ctx	ctx;
